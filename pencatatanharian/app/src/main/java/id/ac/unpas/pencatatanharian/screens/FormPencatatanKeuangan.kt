package id.ac.unpas.pencatatanharian.screens
...
import id.ac.unpas. pencatatanharian.model.pencatatanharian
import id.ac.unpas. pencatatanharian.ui.theme.Purple700
import id.ac.unpas. pencatatanharian.ui.theme.Teal200

/* Dika Sulaeman Akbar 203040163*/
/* Tugas fungsi callback*/
@Composable
fun FormPencatatanKeuangan(onSimpan: (pencatatanharian) -> Unit) {
    ...
    Column(modifier = Modifier
        ...
        Row (modifier = Modifier.padding(4.dp).fillMaxWidth()) {
            Button(modifier = Modifier.weight(5f), onClick = {
                ...
                val item = pencatatanharian(tanggal.value.text, keterangan.value.text,
                ...
                if (!pemasukan.value.text.isEmpty() && !pengeluaran.value.text.isEmpty()){
                    Toast.makeText(context,  "hanya satu field boleh diisi (pemasukan atau pengeluaran", Toast.LENGTH_SHORT).show()
                    return@Button
                }
